...
// Plugins Modal & Comprehensive Massive Marketplace (108+ Plugins)
const MARKETPLACE_CATEGORIES = [
  { id: "all", label: "全部", icon: "sparkles" },
  { id: "hot", label: "🔥 热门精选", icon: "flame" },
  { id: "frontend", label: "🎨 前端与UI", icon: "palette" },
  { id: "backend", label: "🗄️ 后端与数据库", icon: "database" },
  { id: "code", label: "💻 编程语言与质量", icon: "code-2" },
  { id: "docs", label: "📊 办公文档与排版", icon: "file-text" },
  { id: "agent", label: "🤖 智能体与自动化", icon: "bot" },
  { id: "devops", label: "🚀 云原生与运维", icon: "server" },
  { id: "git", label: "🌿 版本控制", icon: "git-branch" },
  { id: "ai", label: "🧠 AI算法与提示词", icon: "cpu" },
  { id: "data", label: "🌐 检索与数据分析", icon: "line-chart" }
];

const MARKETPLACE_PLUGINS = [
  // ── 1. 前端与设计 (Frontend & UI/UX) ──
  {
    id: "ui-ux-pro-max",
  ...
  // ── 2. 代码质量、测试与重构 (Code Quality & Testing) ──
  {
    id: "code-reviewer",
    name: "AI Code Reviewer Pro",
    category: "code",
    categoryLabel: "编程语言与质量",
    icon: "🔍",
    badge: "官方精选",
  ...
  // ── 4. 文档与办公套件 (Docs & Office) ──
  {
    id: "slides",
    name: "Strategic HTML Presentation Slides",
    category: "docs",
    categoryLabel: "办公文档与排版",
    icon: "📽️",
    badge: "高质感汇报",
  ...
  // ── 5. 智能体协作与自主闭环 (Agents & Automation) ──
  {
    id: "pua",
    name: "High-Agency Dev Loop Engine",
    category: "agent",
    categoryLabel: "智能体与自动化",
    icon: "⚡",
    badge: "极高自主权",
  ...
  // ── 6. 云原生、DevOps 与运维 (DevOps & Cloud) ──
  {
    id: "docker-devops",
    name: "Docker & CI/CD Pipeline",
    category: "devops",
    categoryLabel: "云原生与运维",
    icon: "🐳",
    badge: "自动化",
  ...
  // ── 7. 版本控制与 Git (Git & Version Control) ──
  {
    id: "git-companion",
  ...
  // ── 9. 检索与数据分析 (Search & Data Science) ──
  {
    id: "web-researcher",
    name: "Deep Web & Markdown Scraper",
    category: "data",
    categoryLabel: "检索与数据分析",
    icon: "🌐",
    badge: "知识检索",
